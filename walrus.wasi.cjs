// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["ConstExpr","ModuleConfig","WasmCustomSections","WasmData","WasmDataSegments","WasmElement","WasmElements","WasmExport","WasmExports","WasmFunction","WasmFunctions","WasmGlobal","WasmGlobals","WasmImport","WasmImports","WasmLocal","WasmLocals","WasmMemories","WasmMemory","WasmModule","WasmProducers","WasmTable","WasmTables","WasmTag","WasmTags","WasmType","WasmTypes","AbstractHeapType","ANYREF","ARRAYREF","AtomicOp","AtomicWidth","ConstExprKind","DataKindTag","ElementItemsTag","ElementKindTag","EQREF","EXNREF","ExportItemTag","ExtendedLoad","EXTERNREF","F32","F64","FUNCREF","FunctionKindTag","GlobalKind","I31REF","I32","I64","ImportKindTag","NULLEXNREF","NULLEXTERNREF","NULLFUNCREF","NULLREF","STRUCTREF","TagKindTag","TypeKind","V128"],"managedRootEntries":["browser.js","index.js","walrus.wasm","walrus.debug.wasm"]}
/* eslint-disable */
/* prettier-ignore */
...
const __wasmDebugFilePath = __nodePath.join(__dirname, 'walrus.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  const __wasiPackageEntry = require.resolve('@napi-rs/wasm-tools-wasm32-wasi')
  const __packagedWasmFilePath = __nodePath.join(__nodePath.dirname(__wasiPackageEntry), 'walrus.wasm32-wasi.wasm')
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error('@napi-rs/wasm-tools-wasm32-wasi is installed but is missing walrus.wasm32-wasi.wasm.')
  }
...
module.exports.ANYREF = __napiModule.exports.ANYREF
module.exports.ARRAYREF = __napiModule.exports.ARRAYREF
...
module.exports.EQREF = __napiModule.exports.EQREF
module.exports.EXNREF = __napiModule.exports.EXNREF
...
module.exports.EXTERNREF = __napiModule.exports.EXTERNREF
module.exports.F32 = __napiModule.exports.F32
module.exports.F64 = __napiModule.exports.F64
module.exports.FUNCREF = __napiModule.exports.FUNCREF
...
module.exports.I31REF = __napiModule.exports.I31REF
module.exports.I32 = __napiModule.exports.I32
module.exports.I64 = __napiModule.exports.I64
module.exports.ImportKindTag = __napiModule.exports.ImportKindTag
module.exports.NULLEXNREF = __napiModule.exports.NULLEXNREF
module.exports.NULLEXTERNREF = __napiModule.exports.NULLEXTERNREF
module.exports.NULLFUNCREF = __napiModule.exports.NULLFUNCREF
module.exports.NULLREF = __napiModule.exports.NULLREF
module.exports.STRUCTREF = __napiModule.exports.STRUCTREF
module.exports.TagKindTag = __napiModule.exports.TagKindTag
module.exports.TypeKind = __napiModule.exports.TypeKind
module.exports.V128 = __napiModule.exports.V128

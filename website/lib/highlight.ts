...
//
// `night-owl` is a cool ink-blue dark theme that matches Direction C (cyan/blue on a
// deep blue-black), so highlighted snippets sit inside the graph palette instead of the
// warm github-dark grey.

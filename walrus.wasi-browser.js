...
export const ANYREF = __napiModule.exports.ANYREF
export const ARRAYREF = __napiModule.exports.ARRAYREF
...
export const EQREF = __napiModule.exports.EQREF
export const EXNREF = __napiModule.exports.EXNREF
export const ExportItemTag = __napiModule.exports.ExportItemTag
export const ExtendedLoad = __napiModule.exports.ExtendedLoad
export const EXTERNREF = __napiModule.exports.EXTERNREF
export const F32 = __napiModule.exports.F32
export const F64 = __napiModule.exports.F64
export const FUNCREF = __napiModule.exports.FUNCREF
export const FunctionKindTag = __napiModule.exports.FunctionKindTag
export const GlobalKind = __napiModule.exports.GlobalKind
export const I31REF = __napiModule.exports.I31REF
export const I32 = __napiModule.exports.I32
export const I64 = __napiModule.exports.I64
export const ImportKindTag = __napiModule.exports.ImportKindTag
export const NULLEXNREF = __napiModule.exports.NULLEXNREF
export const NULLEXTERNREF = __napiModule.exports.NULLEXTERNREF
export const NULLFUNCREF = __napiModule.exports.NULLFUNCREF
export const NULLREF = __napiModule.exports.NULLREF
export const STRUCTREF = __napiModule.exports.STRUCTREF
export const TagKindTag = __napiModule.exports.TagKindTag
export const TypeKind = __napiModule.exports.TypeKind
export const V128 = __napiModule.exports.V128
